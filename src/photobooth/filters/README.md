...
There are dozens of online services with allow to modify or enhance your images using "AI", but my approach uses local-only services with https://github.com/lllyasviel/stable-diffusion-webui-forge running in the background either on the machine running photobooth-app or a separate computer.
